        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="./about.php">Contact</a>                    
                    </li>
                    <?php
...
<div class="content-wrapper">
        ...
        <p>
  <h1><u>Contact EliteTimepieces at:</u></h1><br>
  
    
      <b>Contact Number:</b>&nbsp;+977 9808168933<br><br>
      <b>Address(physical):</b>&nbsp;Banepa-6,budol, kavrepalanchowk <br><br>
      <b>For any queries:</b>&nbsp;queriesatelite11@gmail.com<br><br>
   ...
   <!-- Contact Us -->
    <div class="col-lg-3 col-md-6 col-sm-12">
                    ...
                    <a href="contact.php" style="color: white;"><li><i class="bi bi-envelope-fill"></i> queriesatelite11@gmail.com</li></a>

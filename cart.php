...
<head>
    ...
    <title>EliteTimepieces Cart Details Page</title>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="d-flex align-items-center gap-4 flex-wrap">
                        ...
                        <h4>Sub-Total: <strong class='text-2'> $total_price</strong></h4>
                          ...
                          <a class='btn btn-dark text-light' href='./checkout.php'>Continue Shopping</a>
                          <a class='btn btn-dark text-light' href='./index.php'>checkout</a>

                    
                        ";
                        }else{
                            echo "<input type='button' value='Continue Shopping' class='btn btn-dark' name='continue_shopping' onclick=\"window.location.href='index.php';\">";
                        }
